...
//  DS1307.begin();
//  DS1307.setDate(16, 07, 05, 2, 18, 30, 00);  // (yy, mm, dd, dow[0 Sun - 6 Sat], 24hh, mm, ss)
}
...
//            RTCValues[6]);
//  if (debug) 
//    Serial.print(F("-> DL1307: Reading RTC Date and Time: "));
...
//    Serial.print(F("\n"));
  ...
  Serial.print(F("RIOT1:  0.6"));             // Node Type and Software Version
